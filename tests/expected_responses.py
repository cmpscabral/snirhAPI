...
networks = [
    models.Network(id="458192970", name="ETA"),
    models.Network(id="920123705", name="Hidrométrica"),
]


stations = [
    models.Station.parse_obj(
        {
            "id": "1627743378",
            "codigo": "19B/01H",
            "nome": "A-DOS-CUNHADOS",
...
parameters = [
    models.Parameter(id="1843", name="Nível hidrométrico Instantâneo"),
    models.Parameter(id="436115734", name="Nível instantâneo máximo anual"),
    models.Parameter(id="1845", name="Nível médio diário"),
]


data = models.DataEntryList.parse_obj(
    [
